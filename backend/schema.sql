...
CREATE TABLE IF NOT EXISTS admins (
    ...
    icon TEXT NOT NULL DEFAULT 'robot' CONSTRAINT admins_icon_check CHECK (icon IN ('dino', 'robot', 'astronaut', 'alien', 'monster', 'ninja', 'mage', 'vampire', 'zombie', 'elf', 'fairy', 'genie', 'superhero', 'supervillain', 'clown', 'ghost', 'rocket', 'crown')),
...
UPDATE admins
SET icon = 'robot'
WHERE icon IS NULL OR icon NOT IN ('dino', 'robot', 'astronaut', 'alien', 'monster', 'ninja', 'mage', 'vampire', 'zombie', 'elf', 'fairy', 'genie', 'superhero', 'supervillain', 'clown', 'ghost', 'rocket', 'crown');
ALTER TABLE admins ALTER COLUMN icon SET NOT NULL;
ALTER TABLE admins DROP CONSTRAINT IF EXISTS admins_icon_check;

ALTER TABLE admins ADD CONSTRAINT admins_icon_check CHECK (icon IN ('dino', 'robot', 'astronaut', 'alien', 'monster', 'ninja', 'mage', 'vampire', 'zombie', 'elf', 'fairy', 'genie', 'superhero', 'supervillain', 'clown', 'ghost', 'rocket', 'crown'));
