...
function Input({ className, type, ...props }: React.ComponentProps<'input'>) {
  return (
    <input
      ...
      data-slot="input"
      className={cn(
        'flex h-9 w-full min-w-0 rounded-md border border-transparent bg-background/70 px-3 py-1 text-sm text-foreground shadow-xs transition-colors outline-none selection:bg-ring/25',
