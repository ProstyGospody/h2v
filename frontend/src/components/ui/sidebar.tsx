...
const sidebarMenuButtonVariants = cva(
  [
    'group/menu-button peer/menu-button relative flex w-full min-w-0 items-center overflow-hidden rounded-[22px] text-left outline-none ring-sidebar-ring transition-[background-color,color] duration-150',
    ...
    'data-[active=true]:[background-image:var(--sidebar-action-active)] data-[active=true]:font-semibold data-[active=true]:text-primary-foreground data-[active=true]:ring-1 data-[active=true]:ring-sidebar-ring/35',
