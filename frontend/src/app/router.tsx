...
const profileIconOptions: Array<{ id: AdminIcon; label: string; src: string }> = [
  ...
  { id: 'monster', label: 'Monster', src: '/profile-icons/monster.svg' },
  { id: 'ninja', label: 'Ninja', src: '/profile-icons/ninja.svg' },
  { id: 'mage', label: 'Mage', src: '/profile-icons/mage.svg' },
  { id: 'vampire', label: 'Vampire', src: '/profile-icons/vampire.svg' },
  { id: 'zombie', label: 'Zombie', src: '/profile-icons/zombie.svg' },
  { id: 'elf', label: 'Elf', src: '/profile-icons/elf.svg' },
  { id: 'fairy', label: 'Fairy', src: '/profile-icons/fairy.svg' },
  { id: 'genie', label: 'Genie', src: '/profile-icons/genie.svg' },
  { id: 'superhero', label: 'Superhero', src: '/profile-icons/superhero.svg' },
  { id: 'supervillain', label: 'Supervillain', src: '/profile-icons/supervillain.svg' },
  { id: 'clown', label: 'Clown', src: '/profile-icons/clown.svg' },
  { id: 'ghost', label: 'Ghost', src: '/profile-icons/ghost.svg' },
