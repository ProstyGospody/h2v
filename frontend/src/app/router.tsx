...
const profileIconOptions: Array<{ id: AdminIcon; label: string; src: string }> = [
  ...
  { id: 'ninja', label: 'Ninja', src: '/profile-icons/ninja.svg' },
  { id: 'alien', label: 'Alien', src: '/profile-icons/alien.svg' },
  { id: 'detective', label: 'Detective', src: '/profile-icons/detective.svg' },
  { id: 'scientist', label: 'Scientist', src: '/profile-icons/scientist.svg' },
  { id: 'technologist', label: 'Technologist', src: '/profile-icons/technologist.svg' },
  { id: 'mechanic', label: 'Mechanic', src: '/profile-icons/mechanic.svg' },
  { id: 'artist', label: 'Artist', src: '/profile-icons/artist.svg' },
  { id: 'singer', label: 'Singer', src: '/profile-icons/singer.svg' },
  { id: 'pilot', label: 'Pilot', src: '/profile-icons/pilot.svg' },
  { id: 'guard', label: 'Guard', src: '/profile-icons/guard.svg' },
  { id: 'prince', label: 'Prince', src: '/profile-icons/prince.svg' },
  { id: 'princess', label: 'Princess', src: '/profile-icons/princess.svg' },
  { id: 'tuxedo', label: 'Tuxedo', src: '/profile-icons/tuxedo.svg' },
